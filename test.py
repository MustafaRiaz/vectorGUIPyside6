...
class SvgViewer(QGraphicsView):
    def __init__(self, svg_path):
        ...
        self.hotspots_data = [
            ...
            {"rect": QRectF(891.50, 373.99, 20.026, 20.026), "type": "switch", "name": "Switch 12", "current_position": "default"},
            {"rect": QRectF(931.50, 295.99, 20.026, 20.026), "type": "switch", "name": "Switch 13", "current_position": "default"},
            {"rect": QRectF(962.50, 325.99, 20.026, 20.026), "type": "switch", "name": "Switch 14", "current_position": "default"},
            {"rect": QRectF(1000.50, 337.99, 20.026, 29.026), "type": "switch", "name": "Switch 15", "current_position": "default"},
            {"rect": QRectF(949.50, 483.99, 20.026, 20.026), "type": "switch", "name": "Switch 16", "current_position": "default"},
            {"rect": QRectF(973.50, 449.99, 20.026, 20.026), "type": "switch", "name": "Switch 17", "current_position": "default"},
            {"rect": QRectF(1003.50, 442.99, 20.026, 29.026), "type": "switch", "name": "Switch 18", "current_position": "default"},
